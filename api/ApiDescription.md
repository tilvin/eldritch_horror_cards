...
* type: `post`
* endpoint:  `/games`
* params example: `{ user_uid: "123" }`
* response: (id игры, token игры, локация текущей экспедиции):
``` JSON
{
      "id": "1",
...
## 2 Показывае пользователю список доступных дополнений

* type: `get`
* endpoint `*/game_sets`
* response: `(id дополнения, идентификатор дополнения):`
``` JSON
[
    {
        "id": 2,
...
## 4 Показываем Пользователю доступных Древних
