////
////  StaticCollectionAdapter.swift
////  EldritchHorrorCards
////
////  Created by Andrey Torlopov on 11/17/18.
////  Copyright © 2018 Andrey Torlopov. All rights reserved.
////
//
//import UIKit
//
//class StaticCollectionAdapter: BaseCollectionAdapter {
//    
//    private var sections: [CollectionCellConfiguration] = []
//    
//    //MARK: - Private methods
//    private func prepare(cell: BaseCollectionViewCell, indexPath: IndexPath) {
...
//        let view = collectionView?.dequeueReusableCell(withReuseIdentifier: config.identifier, for: config.
////        ) dequeueReusableHeaderFooterView(withIdentifier: config.identifier)
